...
$route['administrateur/modifier'] = 'parametres/updateUser' ;
$route['fiches/enregistrer'] = 'fiches/register' ;
...
$route['calibrage'] = 'Calibrage' ;
$route['slugs'] = 'Titres' ;
$route['parametres'] = 'Parametres' ;
$route['listes-questions'] = 'Listes' ;
$route['deconnecter'] = 'login/deconnect' ;
$route['fiches'] = 'Fiches' ;
$route['utilisateur'] = 'utilisateur' ;
$route['overview'] = 'utilisateur/overview' ;
$route['version'] = 'version' ;
$route['version/update'] = 'version/updateVersion' ;
